...
CREATE TABLE [gestao_reembolso].[REEMBOLSO](
	ID_REEMBOLSO INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
	ID_LOTE_REEMBOLSO VARCHAR(60) NOT NULL,
...
CREATE TABLE [gestao_reembolso].[REEMBOLSO_PAGAMENTO](
	...
	ID_REEMBOLSO INT NOT NULL REFERENCES [gestao_reembolso].[REEMBOLSO](ID_REEMBOLSO),
...
CREATE TABLE [gestao_reembolso].[REEMBOLSO_INTEGRACAO](
	...
	DS_MENSAGEM_ERRO  		VARCHAR(50) NULL,
